...
Dependency Injection: Applied to improve scalability and testability.

Kotlin Flow (ViewModel): Used for reactive state management and data handling.

MVVM (Clean Architecture): Ensures clear separation of concerns and a maintainable codebase.

Voyager Navigation: Provides seamless navigation between screens using Jetpack Compose.
...
Build and run the app on an Android emulator or connected device.
